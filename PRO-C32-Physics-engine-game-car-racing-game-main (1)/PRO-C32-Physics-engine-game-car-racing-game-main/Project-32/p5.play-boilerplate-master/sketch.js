...
function preload()
{
  ...
  WonImg = loadImage("images/Winner.png");
...
if(frameCount%80===0){
  ...
  coronaGroup.add(corona);
     ...
     textSize(30);
    fill("red");
        text("Immune Power Score: "+score , width-500 , 30);
...
// This is game is to see if you are careful and immune to corona or not!
// Corona virus is dangerous
// You have to escape from corona and gain more immunity stone(diamond) to get more immune power
// You are travelling in a car - so assume yourself as the car in the game.

// About score?

// You should reach 30 points/score to get immune to corona - Then you win the game
// If your score is less than 0 then you are no immune - Then you lose the game

// How can you play the game?

// You should press up and down arrow key to move
// Messages would pop up when you do good
// Watch out! There could be invisible corona and immune stones too...
